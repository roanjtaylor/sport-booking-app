      ...
      <div className="flex flex-col gap-4">
        ...
        >
          <div className="p-4">
            ...
            <p className="text-sm text-gray-600 ml-8">
              Book the entire facility for your group. You're responsible for
              all players and the full cost.
            </p>
          </div>
        </Card>
        ...
        >
          <div className="p-4">
            ...
            <p className="text-sm text-gray-600 ml-8">
              Join an existing lobby or create a new one. Booking will be
              confirmed once there are {minPlayers} players.
            </p>
          </div>
        </Card>
      </div>
