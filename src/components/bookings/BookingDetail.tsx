              ...
              {isLobbyBooking(booking) && (
                <div>
                  ...
                  <dd className="mt-1 text-gray-900 flex items-center">
                    ...
                    />
                    {booking.notes &&
                      booking.notes.includes("players") &&
          ...
          <div>
            ...
            <dl className="space-y-3 text-sm">
              ...
              <div>
                ...
                <dd className="mt-1 text-gray-900">
                  {booking.facility ? booking.facility.address : "N/A"},{" "}
                  {booking.facility ? booking.facility.city : "N/A"},
                  {booking.facility ? booking.facility.postal_code : "N/A"}
                </dd>
              </div>
              <div>
                <dt className="text-gray-500">Contact</dt>
                <dd className="mt-1 text-gray-900">
                  {booking.facility?.owner_email ||
