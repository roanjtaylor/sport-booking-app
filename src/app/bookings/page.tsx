...
/**
 * Page component for displaying a user's bookings
 * Uses client-side data fetching as it requires authentication
 */
export default function BookingsPage() {
  ...
  const filteredBookings = bookings.filter((booking: ExtendedBooking) => {
