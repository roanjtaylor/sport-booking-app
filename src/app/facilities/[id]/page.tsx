...
export default async function FacilityDetailPage({ params }: Props) {
  ...
  const formattedBookings = (existingBookings || []).map((booking: { start_time: any; end_time: any; date: any; }) => ({
    ...
    <div>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-8">
          <div>
            <h1 className="text-3xl font-bold mb-2">{formattedFacility.name}</h1>
            <p className="text-gray-600">{formattedFacility.address}, {formattedFacility.city}, {formattedFacility.postal_code}</p>
          </div>
          ...
          <Card>
            <div className="p-6">
              ...
              <p className="text-gray-700 mb-6">{formattedFacility.description}</p>
